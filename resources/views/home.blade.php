...
<section class="pt-120 pb-120">
    <div class="container">
        ...
        <div class="row mt-5 pt-1">
            <div class="col-12">
                <!-- Swiper -->
                <div class="swiper walletCarousel" data-swiper-loop="true" data-swiper-items="auto" data-swiper-margin="30" data-swiper-autoplay="true">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="https://metamask.io/download.html" target="_blank" class="wallet">
                                <img src="{{asset('frontend/assets/img/media/wallet1.png')}}" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://user.bitski.com/" target="_blank" class="wallet">
                                <img src="{{asset('frontend/assets/img/media/wallet2.png')}}" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://wallet.klaytn.com/" target="_blank" class="wallet">
                                <img src="{{asset('frontend/assets/img/media/wallet3.png')}}" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://fortmatic.com/" target="_blank" class="wallet">
                                <img src="{{asset('frontend/assets/img/media/wallet4.png')}}" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://authereum.com/welcome/" target="_blank" class="wallet">
                                <img src="{{asset('frontend/assets/img/media/wallet5.png')}}" alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://www.venly.io/" target="_blank" class="wallet">
                                <img src="{{asset('frontend/assets/img/media/wallet6.png')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="vdo-btn-wrapper gradient-box">
                    <img src="{{asset('frontend/assets/img/icons/bg-play.png')}}" class="gradient-box-icon" alt="">
                    <a href="https://www.youtube.com/watch?v=gfGuPd1CELo" class="vdo_btn popup-video icon-mobile-white">
                        <img src="{{asset('frontend/assets/img/icons/play.svg')}}" alt="" class="svg">
...
<section class="pt-120 pb-120 section-shape">
    <div class="container mt-60 mt-lg-0">
        ...
        <div class="row">
            <div class="col-12">
                <!-- Swiper -->
                <div class="swiper live-auction" data-swiper-loop="true" data-swiper-items="3" data-swiper-margin="30" data-swiper-breakpoints='{"0": {"slidesPerView": "1"}, "768": {"slidesPerView": "2"}, "1200": {"slidesPerView": "3"}}'>
                    <div class="swiper-wrapper mb-60">
                        <div class="swiper-slide">
                            <!-- Single Product -->
                            <div class="single-product style--one">
                                <img src="{{asset('frontend/assets/img/product/product1.png')}}" alt="">
                                    ...
                                    <div class="product-bottom">
                                        ...
                                        <div class="button-group">
                                            ...
                                            <div class="dropdown mr-10">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" target="_blank" href="https://www.facebook.com/"><img src="{{asset('frontend/assets/img/icons/facebook.svg')}}" alt=""> Share on
                                                            Facebook</a></li>
                                                    <li><a class="dropdown-item" target="_blank" href="https://www.twitter.com/"><img src="{{asset('frontend/assets/img/icons/twitter.svg')}}" alt=""> Share on
                                                            Twitter</a></li>
                                                    <li><a class="dropdown-item" target="_blank" href="https://www.Instagram.com/"><img src="{{asset('frontend/assets/img/icons/instagram.svg')}}" alt=""> Share
                                                            on Instagram</a></li>
                                                    <li><a class="dropdown-item" target="_blank" href="https://www.linkedin.com/"><img src="{{asset('frontend/assets/img/icons/linkedin.svg')}}" alt=""> Share on
                                                            Linkedin</a></li>
                                                </ul>
                                            </div>
                        ...
                        <div class="swiper-slide">
                            <!-- Single Product -->
                            <div class="single-product style--one">
                                <img src="{{asset('frontend/assets/img/product/product2.png')}}" alt="">
                        ...
                        <div class="swiper-slide">
                            <!-- Single Product -->
                            <div class="single-product style--one">
                                <img src="{{asset('frontend/assets/img/product/product3.png')}}" alt="">
    ...
    <div class="swiper explore-feeds" data-swiper-loop="true" data-swiper-items="auto" data-swiper-margin="30">
        <div class="swiper-wrapper mb-60">
            <div class="swiper-slide">
                <!-- Single Product -->
                <div class="single-product style--one">
                    <img src="{{asset('frontend/assets/img/product/product4.png')}}" alt="">
                            ...
                            <div class="button-group">
                                ...
                                <div class="dropdown mr-10">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" target="_blank" href="https://www.facebook.com/"><img src="{{asset('frontend/assets/img/icons/facebook.svg')}}" alt=""> Share on
                                                Facebook</a></li>
                                        <li><a class="dropdown-item" target="_blank" href="https://www.twitter.com/"><img src="{{asset('frontend/assets/img/icons/twitter.svg')}}" alt=""> Share on Twitter</a>
                                        </li>
                                        <li><a class="dropdown-item" target="_blank" href="https://www.Instagram.com/"><img src="{{asset('frontend/assets/img/icons/instagram.svg')}}" alt=""> Share on
                                                Instagram</a></li>
                                        <li><a class="dropdown-item" target="_blank" href="https://www.linkedin.com/"><img src="{{asset('frontend/assets/img/icons/linkedin.svg')}}" alt=""> Share on
                                                Linkedin</a></li>
                                    </ul>
            ...
            <div class="swiper-slide">
                <!-- Single Product -->
                <div class="single-product style--one">
                    <img src="{{asset('frontend/assets/img/product/product5.png')}}" alt="">
            ...
            <div class="swiper-slide">
                <!-- Single Product -->
                <div class="single-product style--one">
                    <img src="{{asset('frontend/assets/img/product/product6.png')}}" alt="">
            ...
            <div class="swiper-slide">
                <!-- Single Product -->
                <div class="single-product style--one">
                    <img src="{{asset('frontend/assets/img/product/product7.png')}}" alt="">
            ...
            <div class="swiper-slide">
                <!-- Single Product -->
                <div class="single-product style--one">
                    <img src="{{asset('frontend/assets/img/product/product8.png')}}" alt="">
        ...
        <div class="row gutter-60">
            <div class="col-lg-4">
                ...
                <div class="support-img">
                    <img src="{{asset('frontend/assets/img/media/support-img.png')}}" alt="">
                </div>
                <!-- End Support IMG -->
            </div>
            <div class="col-lg-8">
                <div class="d-flex justify-content-end mb-60">
                    ...
                    <div class="quick-contact gradient-box">
                        <img src="{{asset('frontend/assets/img/icons/phone.png')}}" class="gradient-box-icon" alt="">
                ...
                <div class="support-content">
                    ...
                    <form action="#" class="support-form row">
                        ...
                        <div class="col-12">
                            <textarea name="message" class="form-control" placeholder="Write Message Here" required></textarea>
                            <button type="submit" class="btn"><img src="{{asset('frontend/assets/img/icons/mail.svg')}}" alt="" class="svg"> Send Request</button>
                        </div>
                    </form>
                    <!-- End Support Form -->
                </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="01">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection1.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h5>Meka_Verse</h5>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="02">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection2.gif')}}" alt="">
                    </div>
                    <div class="content">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="03">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection3.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h5>Bambooz_lers</h5>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="04">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection4.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h5>The_Humanoids</h5>
                        <span>$7,991,156</span>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="05">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection5.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h5>Stacked_Toadz</h5>
                        <span>$6,700,653</span>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="06">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection6.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h5>Mutant_Cats</h5>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="07">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection7.gif')}}" alt="">
                    </div>
                    <div class="content">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="08">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection8.png')}}" alt="">
                    </div>
                    <div class="content">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="09">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection9.gif')}}" alt="">
                    </div>
                    <div class="content">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="10">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection10.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h5>Cyber_Kongz</h5>
                        <span>$7,227,956</span>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="11">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection11.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h5>The_DogePound</h5>
                        <span>$6,609,169</span>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                ...
                <a href="collection.html" class="single-collection" data-count="12">
                    <div class="collection-img">
                        <img src="{{asset('frontend/assets/img/collections/collection12.gif')}}" alt="">
                    </div>
                    <div class="content">
